...
import 'package:ny_telemedicine/Models/Record.dart';
...
class BodyState extends State<Body> {
  ...
  Future<void> readEmailFromStorage() async {
    ...
    Uri url = Uri.parse("${recordUrl}record/get/record");
  ...
  Future updateAllergies() async {
    ...
    Uri url = Uri.parse("${recordUrl}record/update/allergies");
    String body = jsonEncode(data);
  ...
  Future updateStatus() async {
    ...
    Uri url = Uri.parse("${recordUrl}record/update/status");
    String body = jsonEncode(data);
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        width: 170.0,
                        margin:
                        const EdgeInsets.only(right: 15.0, bottom: 20.0, top: 20.0),
